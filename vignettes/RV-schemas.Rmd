...
For more information about the builtin rules and how they operate, or how to add custom rules to a `Registry`, see the other vignettes: `vignette("RV-rules")` and `vignette("RV-adding-rules")`.
.
